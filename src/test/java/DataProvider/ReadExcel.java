...
public class ReadExcel {
	...
	{
		File src = new File("./Data/"+ FileName +".xlsx"); //You need to specify the location where excel file is saved in your system.
		try 
		{
		...
		catch (Exception e) {System.out.println("The exception is: " +e.getMessage());}
	}
	
	//This method would fetch the data from the corresponding cell of the excel sheet and return as a String.
	public static String getData(int sheet,int row, int column)
	{
		String data;
